...
var div = dom.create("<div>new_parent</div>"); //dom.after(test, span);
...
var temp = dom.find(".blue", test1)[0];
console.log(temp);
var c1 = dom.find("#c1")[0];
var c3 = dom.find("#c3")[0];
console.log(dom.siblings(c1));
console.log(dom.previous(c3));
var t = dom.find("#travel")[0];
dom.travel(t.children, function (n) {
  dom.style(n, "color", "green");
});
var t3 = dom.find("#t3")[0];
